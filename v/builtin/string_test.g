...
test_ranges()
/*
ranges_propagate_first(s string) !string
ranges_propagate_last(s string) !string
ranges_propagate_both(s string) !string
*/
test_split_nth()
test_rsplit_nth()
test_split_nth_values()
test_rsplit_nth_values()
test_split()
test_rsplit()
test_split_any()
test_rsplit_any()
...
test_contains_any()
test_contains_only()
test_contains_any_substr()
test_arr_contains()
test_to_num()
test_to_u8_array()
test_inter_format_string()
test_hash()
test_trim()
test_trim_indexes()
test_trim_left()
...
test_repeat()
test_starts_with()
test_starts_with_capital()
test_trim_string_left()
test_trim_string_right()
test_raw()
test_raw_with_quotes()
test_escape()
test_atoi()
test_raw_inter()
test_c_r()
test_inter_before_comptime_if()
test_double_quote_inter()
//foo(b u8) u8
//filter(b u8) bool
test_split_into_lines()
test_string_literal_with_backslash_followed_by_newline()
test_string_alias()
test_sorter()
test_fields()
test_interpolation_after_quoted_variable_still_works()
//test_emoji_to_runes()
//test_string_to_rune()
test_index_any()
test_string_f64()
...
test_string_with_zero_byte_escape()
test_is_blank()
test_indent_width()
test_index_u8()
test_last_index()
