	...
	#define V_COMMIT_HASH "b6d20e6ac36d2f12213079e4fa4a1437a1b74b1f"
#endif
...
//     All custom defines      : 
//     Turned ON custom defines: 
#define CUSTOM_DEFINE_
...
// for __offset_of
	...
	// and does not support __has_attribute(visibility) ...
		...
		#endif
		#if defined(__clang__) && defined(_VBUILDMODULE)
...
bool builtin__print_backtrace_skipping_top_frames(int xskipframes) {
	...
	#else
	{
		...
		#else
		{
			builtin__println(builtin__str_intp(2, _MOV((StrIntpData[]){{_S("print_backtrace_skipping_top_frames is not implemented. skipframes: "), 0xfe07, {.d_i32 = skipframes}}, {_SLIT0, 0, { .d_c = 0 }}})));
		}
		#endif
	}
	#endif
...
string hello__hello(void) {
	return _S("Hello world !");
}
VV_LOC void main__main(void) {
	builtin__println(hello__hello());
}
void _vinit(int ___argc, voidptr ___argv) {
